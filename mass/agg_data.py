...
if __name__ == '__main__':
    ...
    process(os.path.join(DATA_DIR, 'scikp/kp20k/train.json'), 'data/raw/kp20k', 'train')
    process(os.path.join(DATA_DIR, 'scikp/kp20k/valid.json'), 'data/raw/kp20k', 'valid')
    process(os.path.join(DATA_DIR, 'scikp/kp20k/test.json'), 'data/raw/kp20k', 'test')
    ...
    process(os.path.join(DATA_DIR, 'scikp/inspec/test.json'), 'data/raw/inspec', 'test')
    process(os.path.join(DATA_DIR, 'scikp/nus/test.json'), 'data/raw/nus', 'test')
    process(os.path.join(DATA_DIR, 'scikp/krapivin/test.json'), 'data/raw/krapivin', 'test')
    process(os.path.join(DATA_DIR, 'scikp/semeval/test.json'), 'data/raw/semeval', 'test')
