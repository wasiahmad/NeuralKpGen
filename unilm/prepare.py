...
if __name__ == '__main__':
    ...
    process(os.path.join(DATA_DIR, 'oagk/processed/train.json'), 'data/oagk_train.json')
    process(os.path.join(DATA_DIR, 'oagk/processed/valid.json'), 'data/oagk_valid.json')
    process(os.path.join(DATA_DIR, 'oagk/processed/test.json'), 'data/oagk_test.json')
